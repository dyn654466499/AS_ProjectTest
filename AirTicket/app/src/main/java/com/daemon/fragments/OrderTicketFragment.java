...
//        List<Resp_OrderTicketQueryInfo> infos = new LinkedList<Resp_OrderTicketQueryInfo>();
//        for(int i = 0;i<5;i++){
//            Resp_OrderTicketQueryInfo info = new Resp_OrderTicketQueryInfo();
//            infos.add(info);
//        }
        ConsumeTicketAdapter adapter = new ConsumeTicketAdapter(getActivity(),infos);
