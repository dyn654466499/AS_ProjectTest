...
//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootLayout = inflater.inflate(R.layout.fragment_order_catering, container, false);
        ListView lv_my_consume_order_catering = (ListView)rootLayout.findViewById(R.id.lv_my_consume_order_catering);
        ConsumeCateringAdapter adapter = new ConsumeCateringAdapter(getActivity(),info);
        lv_my_consume_order_catering.setAdapter(adapter);
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                ScrollView sv = (ScrollView)rootLayout.findViewById(R.id.sv_my_consume_catering);
