...
public class AirTicketModel extends BaseModel{
    private Context mContext;
	public AirTicketModel(Handler handler,Context context) {
		super(handler);
	...
	public void changeModelState(Message changeStateMessage) {
		...
		switch (changeStateMessage.what){
			case Constants.MODEL_TICKET_SEARCH:
                                ...
                                switch (eventType) {
                                    case XmlPullParser.START_TAG:
                                        if("string".equals(xmlPullParser.getName())){
                                            ...
                                            Message.obtain(handler,Constants.VIEW_TICKET_SEARCH,message).sendToTarget();
                                        }
